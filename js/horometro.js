...
am5.ready(function () {
    ...
    var root = am5.Root.new("chartdivhorometro");
    ...
    //chart.getNumberFormatter().set("numberFormat", "#'h'");
    ...
    var label = chart.radarContainer.children.push(
        am5.Label.new(root, {
            ...
            fontSize: "1.2em" // tamaño de la fuente del centor de de el gauge
        })
    );
    ...
    bullet.get("sprite").on("rotation", function () {
        ...
        label.set("text", Math.round(value).toString() + "h");
    });

    setInterval(function () {
        var value = Math.round(Math.random() * 24);
